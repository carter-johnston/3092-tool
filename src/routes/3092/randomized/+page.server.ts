...
export const actions: Actions = {
	default: async ({ request }) => {
		...
		const firstName = Math.floor(Math.random() * firstNames.length);
		const lastName = Math.floor(Math.random() * lastNames.length);
		const address1 = Math.floor(Math.random() * addresses1.length);
		const address2 = Math.floor(Math.random() * addresses2.length);
		const address3 = Math.floor(Math.random() * addresses3.length);
		...
		const postalCode = Math.floor(Math.random() * postalCodes.length);
		...
		function generateRandomSSN() {
			const group1 = Math.floor(Math.random() * 899) + 100;
			const group2 = Math.floor(Math.random() * 99);
			const group3 = Math.floor(Math.random() * 9999);

			const randomSSN = group1 + group2 + group3;
